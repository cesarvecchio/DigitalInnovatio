...
public class ExemploStreamAPI {
    public static void main(String[] args) {
        ...
        // Retorna a contagem de elementos dd stream
        ...
        System.out.println("Retorna um nova coleção com a quantidade de letras: " + estudantes.stream().map(estudante ->
                estudante.concat(" - ").concat(String.valueOf(estudante.length()))).collect(Collectors.toList()));

        // Retorna somente os 3 primeiros elementos da coleção
        System.out.println("Retorna os elementos: " + estudantes.stream().limit(3).collect(Collectors.toList()));
        ...
        // Retorna o primeiro elemento da coleção, se existe exibe no console
